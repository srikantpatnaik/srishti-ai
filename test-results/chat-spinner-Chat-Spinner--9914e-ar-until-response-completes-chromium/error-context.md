...
- Name: chat-spinner.spec.ts >> Chat Spinner and Tick >> tick should not appear until response completes
- Location: tests/chat-spinner.spec.ts:45:3
...
Locator: getByTestId('message-spinner')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByTestId('message-spinner')
